...
public class Rent_equipment extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要租借的设备ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().rent_equipment(id, factory, user_id, p);
	...
	private Rent_equipment() {
		
	}
	public static Rent_equipment frame = new Rent_equipment();
	
	public static Rent_equipment getInstance() {
		return frame;
	}
}
