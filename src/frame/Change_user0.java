...
public class Change_user0 extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要修改的用户ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().change_user0(id,user_id, p);
	...
	private Change_user0() {
		
	}
	public static Change_user0 frame = new Change_user0();
	
	public static Change_user0 getInstance() {
		return frame;
	}
}
