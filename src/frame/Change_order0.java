...
public class Change_order0 extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要修改的订单ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().change_order0(id,user_id, p);
	...
	private Change_order0() {
		
	}
	public static Change_order0 frame = new Change_order0();
	
	public static Change_order0 getInstance() {
		return frame;
	}
}
