...
public class Take_order extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要接的订单ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().take_order(id, factory, user_id, p);
	...
	public static Take_order frame = new Take_order();
	
	public static Take_order getInstance() {
		return frame;
	}
}
