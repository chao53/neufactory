...
public class Change_equipment extends JFrame {
				...
				try {
					...
					btnNewButton_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							Controller.getInstance().change_equipment(id, description, user_id, p);
					...
					JLabel lblNewLabel = new JLabel("请输入新的设备描述");
	...
	private Change_equipment() {	
		
	}
	public static Change_equipment frame = new Change_equipment();
	public static Change_equipment getInstance() {
		return frame;
	}
}
