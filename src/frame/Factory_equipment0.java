...
public class Factory_equipment0 extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要管理的工厂ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().factory_equipment0(id,user_id, p);
	...
	private Factory_equipment0() {
		
	}
	public static Factory_equipment0 frame = new Factory_equipment0();
	
	public static Factory_equipment0 getInstance() {
		return frame;
	}
}
