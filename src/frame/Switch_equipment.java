...
public class Switch_equipment extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要操控的设备ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().switch_equipment(id,user_id, p);
	...
	private Switch_equipment() {
		
	}
	public static Switch_equipment frame = new Switch_equipment();
	
	public static Switch_equipment getInstance() {
		return frame;
	}
}
