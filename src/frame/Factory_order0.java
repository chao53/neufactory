...
public class Factory_order0 extends JFrame {
				...
				try {
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().factory_order0(id,user_id, p);
	...
	private Factory_order0() {
		
	}
	public static Factory_order0 frame = new Factory_order0();
	
	public static Factory_order0 getInstance() {
		return frame;
	}
}
