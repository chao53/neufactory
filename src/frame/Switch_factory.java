...
public class Switch_factory extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要操控的工厂ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().switch_factory(id,user_id, p);
	...
	private Switch_factory() {
		
	}
	public static Switch_factory frame = new Switch_factory();
	
	public static Switch_factory getInstance() {
		return frame;
	}
}
