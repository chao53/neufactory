...
public class Change_product extends JFrame {
				...
				try {
					...
					btnNewButton_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							Controller.getInstance().change_product(id, description, user_id, p);
					...
					JLabel lblNewLabel = new JLabel("请输入新的产品描述");
	...
	private Change_product() {	
		
	}
	public static Change_product frame = new Change_product();
	public static Change_product getInstance() {
		return frame;
	}
}
