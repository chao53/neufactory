...
public class Change_product0 extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要修改的产品ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().change_product0(id,user_id, p);
	...
	private Change_product0() {
		
	}
	public static Change_product0 frame = new Change_product0();
	
	public static Change_product0 getInstance() {
		return frame;
	}
}
