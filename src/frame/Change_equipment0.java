...
public class Change_equipment0 extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要修改的设备ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().change_equipment0(id,user_id, p);
	...
	private Change_equipment0() {
		
	}
	public static Change_equipment0 frame = new Change_equipment0();
	
	public static Change_equipment0 getInstance() {
		return frame;
	}
}
