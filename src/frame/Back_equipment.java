...
public class Back_equipment extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要归还的设备ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().back_equipment(id, factory, user_id, p);
	...
	private Back_equipment() {
		
	}
	public static Back_equipment frame = new Back_equipment();
	
	public static Back_equipment getInstance() {
		return frame;
	}
}
