...
public class Del_order extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要移除的订单ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().del_order(id, user_id, p);
	...
	public static Del_order frame = new Del_order();
	
	public static Del_order getInstance() {
		return frame;
	}
}
