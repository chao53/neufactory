...
public class Change_factory0 extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要修改的工厂ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().change_factory0(id,user_id, p);
	...
	private Change_factory0() {
		
	}
	public static Change_factory0 frame = new Change_factory0();
	
	public static Change_factory0 getInstance() {
		return frame;
	}
}
