...
public class Change_order extends JFrame {
				...
				try {
					...
					btnNewButton_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							Controller.getInstance().change_order(id, description, user_id, p);
					...
					JLabel lblNewLabel = new JLabel("请输入新的收货地址");
	...
	private Change_order() {	
		
	}
	public static Change_order frame = new Change_order();
	public static Change_order getInstance() {
		return frame;
	}
}
