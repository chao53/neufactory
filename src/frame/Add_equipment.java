...
public class Add_equipment extends JFrame {
	...
	public void notmain(String factory,String user_id,int p) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame.setVisible(true);
					frame.setTitle("添加新设备");
					...
					btnNewButton_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().add_equipment(name, description, factory, user_id,p);
	...
	private Add_equipment() {

	}
	
	public static Add_equipment frame = new Add_equipment();
	
	public static Add_equipment getInstance() {
		return frame;
	}
}
