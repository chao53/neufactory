...
public class Del_equipment extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					JLabel lblNewLabel_1 = new JLabel("请输入要删除的设备ID");
					...
					btnNewButton_1_1.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							Controller.getInstance().del_equipment(id,user_id, p);
	...
	private Del_equipment() {
		
	}
	public static Del_equipment frame = new Del_equipment();
	
	public static Del_equipment getInstance() {
		return frame;
	}
}
